...
export async function getAIResponse(question, topic) {
    try {
...
export async function escalateToDepartment(chatHistory) {
    try {
...
export async function getTopicSuggestions(categoryName) {
    try {

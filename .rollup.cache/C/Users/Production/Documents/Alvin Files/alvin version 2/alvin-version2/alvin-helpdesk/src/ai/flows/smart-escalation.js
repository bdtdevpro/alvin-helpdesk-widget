...
const SmartEscalationOutputSchema = z.object({
    department: z
        .string()
        .describe('The appropriate department to escalate the inquiry to (e.g., HR, IT, Benefits).'),
    reason: z
        .string()
...
export async function smartEscalation(input) {
...
//# sourceMappingURL=smart-escalation.js.map